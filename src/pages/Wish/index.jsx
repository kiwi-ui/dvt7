          ...
          <div className="text-dark" >
            ...
            <form name="wishApp" id='form' className="text-start" onSubmit={sendWish}>
              ...
              <div className="text-end">
                <button className="btn bgButtonPrime text-white d-flex flex-row align-items-center my-3 gap-2 ms-auto fw-semibold rounded-pill shadow" disabled={loading} type="submit" data-aos="zoom-in-down" data-aos-duration="2400">
                  {
                    loading ? 
            ...
            <div id='wishes' className={`border-up border-2 border-dark-subtle pt-3 mt-4 `}>
